...
if(isset($_POST['Ajouter'])){
  ...
  $target_dir = "uploads/".$category."/";
   ...
   echo '<script>alert("Veuillez remplir le champ nouveauté!")</script>';
    ...
    echo $result = mysqli_query($dbconn,$sql);
    header('Location: olympiadesL.php');
   }
   else{
...
if(isset($_POST['Supprimer'])){
 ...
 $sql="DELETE FROM lessons WHERE fileLocation='".$location."' AND category='olympiades'";
  echo $result = mysqli_query($dbconn,$sql);
 header('Location: olympiadesL.php');
}
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
              ...
              <div class="dropdown">
                ...
                <a href="olympiadesL.php" class="nav-item nav-link active">Olympiades</a>
  ...
  <div id="main-content" class="container">
    ...
    <h2 class="text-center">Olympiades</h2>
   ...
   <ul>
    <?php 
         ...
         $result = mysqli_query($dbconn,"SELECT fileLocation FROM lessons WHERE category='olympiades'");
